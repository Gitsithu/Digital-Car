                ...
                <div class="media-body py-md-4">
                    <div class="d-flex mb-3 align-items-center">
                        ...
                        <div class="text">
                          <h3 class="heading mb-0 pl-3">
                              Fuel
                              <span><?php echo $objs[0]->fuel; ?></span>
                          </h3>
                      </div>
                  </div>
                </div>
                                  ...
                                  <div class="row">
                                      <div class="col-md-12">
                                          <ul class="features">
                                              ...
                                              <li class="check"><span class="ion-ios-checkmark"></span>Model => <?php echo $objs[0]->model; ?></li>
          ...
          <div class="container">          
            ...
            <div class="form-group">                      
             ...
             <div class="col-md-4">
                ...
                <a class="btn btn-warning" style="width:200px;margin-left:55px;" type="button" href='/registration/edit/{{ $objs[0]->id }}'>Register</a> 
           </div>
             </div>
             </div>
