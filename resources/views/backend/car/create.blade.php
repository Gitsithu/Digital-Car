                            ...
                            <form action="/backend/car" method="post" enctype="multipart/form-data"> <form>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control"value="{{ old('cartype_id') }}" name="cartype_id" id="cartype_id">
                                        ...
                                        @foreach($cartypes as $cartype)
                                            <option value="{{$cartype->id}}">{{$cartype->name}} ==> @if($cartype->status==1) {{'Valid'}}  @else{{'Invalid'}}@endif</option>
                                        @endforeach
                                    </select>
                                  </div>
                                </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" value="{{ old('brand_id') }}" name="brand_id" id="brand_id">
                                       ...
                                       @foreach($brands as $brand)
                                           <option value="{{$brand->id}}">{{$brand->name}} ==> @if($brand->status==1) {{'Valid'}}  @else{{'Invalid'}}@endif</option>
                                       @endforeach
                                   </select>
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4 px-md-1">
                                  <div class="form-group">
                                    <label>Fuel</label>
                                    <input type="text" name="fuel" value="{{ old('fuel') }}" class="form-control" placeholder="Octane 95 or 92 or Diesel">
                                  </div>
                                </div>
                                <div class="col-md-4 px-md-1">
                                  <div class="form-group">
                              ...
                              <div class="row">
                               <div class="col-md-4 pl-md-1">
                                  <div class="form-group">
                                    <label>Price</label>
                                    <input type="text" value="{{ old('price') }}" name="price" class="form-control" placeholder="Price Ks or $">
                                  </div>
                                </div>
                                <div class="col-md-4 pr-md-1">
                                  <div class="form-group">
