                        ...
                        <tr>
                          ...
                          <td>
                                <form action="/backend/registration/{{ isset($registration)? $registration->id:0 }}" method="post"  enctype="multipart/form-data">
                                    ...
                                    {{csrf_field()}}
                                    {{ method_field('PATCH') }}
                                    <button type="submit" value="2" name="status"  class="btn btn-fill btn-success" onclick="return myfucntion();"><i class="tim-icons icon-check-2"></i> Confirm</button>

                                </td>
                                <td>
                          
                                <button type="submit" value="0" name="status" class="btn btn-fill btn-danger" onclick="return myfucntion1();"><i class="tim-icons icon-simple-remove"></i> Deny</button>
                          </form>
                          </td>
                        </tr>
                        @endforeach
