...
class CarController extends Controller
{
    ...
    public function create()
    {
        ...
        $cartypes = DB::select('select * from cartype');
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            if($image = $request->file('image')){
                ...
                DB::update('update car set  price = ?,  image = ?, status = ?, description = ?, updated_at = ? where id = ?', [$price,$image_file,$status,$description,$updated_at,$id]);
            }
            else{
                DB::update('update car set price = ?,status = ?, description = ?, updated_at = ? where id = ?', [$price,$status,$description,$updated_at,$id]);
            }
